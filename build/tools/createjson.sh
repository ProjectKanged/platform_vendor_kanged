...
existingOTAjson=./vendor/kangedOTA/$1.json
output=$2/$1.json
...
if [ -f $existingOTAjson ]; then
	...
	filename=$3
	download="https://sourceforge.net/projects/projectkanged/files/${major_version}.x/$6/$1/$filename/download"
	version=`echo $4-$5`
	...
	echo 'Consider adding official support by reading the documentation at https://github.com/ProjectKanged-devices/android_vendor_kangedOTA/blob/fourteen/README.md'
fi
